...
package Slic3r::i18n::TextDomain;
...
sub __ ($)
{
	...
	use Encode;
    return decode("utf8", dgettext $textdomain => $msgid);
}
...
sub __x ($@)
{
	...
	use Encode;
    return decode("utf8", __expand ((dgettext $textdomain => $msgid), %vars));
}
...
#    Locale::TextDomain->export_to_level (1, $package, @EXPORT);
    Slic3r::i18n::TextDomain->export_to_level (1, $package, @EXPORT);
